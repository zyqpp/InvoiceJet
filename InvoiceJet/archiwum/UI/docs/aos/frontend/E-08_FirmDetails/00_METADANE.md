...
### Powiązane ekrany
- Ekran Klienci (`E-06_Clients`) — wykorzystuje ten sam serwis `FirmService` i model `IFirm`
- Ekran Konta bankowe (`E-09_BankAccounts`) — konta bankowe przypisane do firmy użytkownika
