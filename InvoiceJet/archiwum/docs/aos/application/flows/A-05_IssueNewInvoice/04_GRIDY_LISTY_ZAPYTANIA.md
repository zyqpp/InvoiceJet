...
| Źródło danych | `MatTableDataSource` z `productsFormArray.controls` |
...
|---|---|
| Pole | `client` |
| Źródło UI | `invoiceAutofillData.clients` |
...
|---|---|
| Pole | `products[].name` |
| Źródło UI | `invoiceAutofillData.products` |
...
|---|---|
| Pole | `documentSeries` |
| Źródło UI | `invoiceAutofillData.documentSeries` |
| Endpoint | `GET /api/Document/GetDocumentAutofillInfo/1` |
